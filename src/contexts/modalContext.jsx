...
export const ModalProvider = ({ children }) => {
    ...
    return (
        <ModalContext.Provider value={{ open, handleOpenModal, handleCloseModal }}>
            {children}
            {open && <ModalWrapper handleCloseModal={handleCloseModal} title={modalInfo.title}>{modalInfo.content}</ModalWrapper>}
            ...
            <div className="pop-new-card__container">
                <div className="pop-new-card__block">
                    <div className="pop-new-card__content">
                        <a href="#" className="pop-new-card__close" onClick={handleCloseModal}>
                            ✖
                        </a>
